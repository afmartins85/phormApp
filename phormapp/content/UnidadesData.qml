    ...
    BorderImage {
        ...
        BorderImage {
            ...
            TextInput{
                ...
                onAccepted: {
                    unitModel.append({"title": textInput.text, "completed": false})
                    connDatabase.maintenanceHandler.unitInsert = textInput.text;
                    textInput.text = ""
                }
            }
        }
    ...
    Component {
        ...
        BorderImage {
            ...
            MouseArea {
                ...
                onClicked: {
                    if (index !== -1 && _synced) {
                        unitModel.setProperty(index, "completed", !completed)
                    }
                }
            }
            ...
            Image {
                ...
                MouseArea {
                    ...
                    anchors.fill: parent
                    onClicked: {
                        connDatabase.maintenanceHandler.unitsListRemove(unitModel.get(index).title);
                        unitModel.remove(index);
                    }
                }
                //![remove]
            }
