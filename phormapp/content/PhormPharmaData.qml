    ...
    BorderImage {
        ...
        BorderImage {
            ...
            TextInput{
                ...
                onAccepted: {
                    phormModel.append({"title": textInput.text, "completed": false})
                    //connDatabase.maintenanceInsert = textInput.text;
                    connDatabase.maintenanceHandler.phormInsert = textInput.text;
    ...
    Component {
        ...
        BorderImage {
            ...
            MouseArea {
                ...
                onClicked: {
                    if (index !== -1 && _synced) {
                        phormModel.setProperty(index, "completed", !completed)
                    }
                }
            }
            ...
            Image {
                ...
                MouseArea {
                    ...
                    anchors.fill: parent
                    onClicked: {
                        connDatabase.maintenanceHandler.phormListRemove(phormModel.get(index).title);
                        phormModel.remove(index);
                    }
                }
                //![remove]
            }
