    ...
    ListModel {
        ...
        Component.onCompleted: {
            ...
            for (var i=0 ; i< connDatabase.maintenanceHandler.groupListCount(); ++i)
                groupModel.append({"title": connDatabase.maintenanceHandler.groupListAt(i)})
        }
    }
    ...
    BorderImage {
        ...
        BorderImage {
            ...
            TextInput{
                ...
                onAccepted: {
                    groupModel.append({"title": textInput.text, "completed": false})
                    connDatabase.maintenanceHandler.group = textInput.text;
                    textInput.text = ""
                }
            }
        }
...
//                    }
            ...
            Image {
                ...
                MouseArea {
                    ...
                    anchors.fill: parent
                    onClicked: {
                        connDatabase.maintenanceHandler.groupListRemove(groupModel.get(index).title);
